...
### 由于现有功能并不能满足所有项目的需求，ThinkAdmin 只做基础底层的开发，这里包括系统权限管理，系统存储配置，微信模块管理，以及常用功能集成等…… 因此 ThinkAdmin 也被定性为包括二开基线项目，目前已经有许多公司及个人在使用，ThinkAdmin v6 是基于 v1-v5 版本的积累，结合 ThinkPHP 6.0  的思维重生调整，减少大量原非必需的组件，自建存储层、服务层及任务机制，增加了许多友好指令！
