...
require.config({
    ...
    paths: {
        ...
        'md5': ['plugs/script/md5.min'],
        'json': ['plugs/script/json.min'],
        'xlsx': ['plugs/script/xlsx.min'],
        'jszip': ['plugs/script/jszip.min'],
        'excel': ['plugs/jquery/excel.xlsx'],
        'marked': ['plugs/script/marked.min'],
        'base64': ['plugs/script/base64.min'],
        ...
        'filesaver': ['plugs/script/filesaver.min'],
        'websocket': ['plugs/socket/websocket'],
        'pcasunzips': ['plugs/script/pcasunzips'],
        'compressor': ['plugs/script/compressor.min'],
