...
INSERT INTO `system_config` VALUES ('storage', 'type', 'txcos');
...
-- ----------------------------
INSERT INTO `system_oplog` VALUES (1, 'admin/login/index', '127.0.0.1', '系统用户登录', '登录系统后台成功', 'admin', '2020-12-21 09:05:09');
INSERT INTO `system_oplog` VALUES (2, 'admin/login/index', '127.0.0.1', '系统用户登录', '登录系统后台成功', 'admin', '2020-12-22 02:18:58');
INSERT INTO `system_oplog` VALUES (3, 'admin/config/storage', '127.0.0.1', '系统配置管理', '修改系统存储参数', 'admin', '2020-12-22 02:21:35');
INSERT INTO `system_oplog` VALUES (4, 'admin/config/storage', '127.0.0.1', '系统配置管理', '修改系统存储参数', 'admin', '2020-12-22 02:22:13');
INSERT INTO `system_oplog` VALUES (5, 'admin/login/index', '127.0.0.1', '系统用户登录', '登录系统后台成功', 'admin', '2020-12-22 06:19:14');
INSERT INTO `system_oplog` VALUES (6, 'admin/login/index', '127.0.0.1', '系统用户登录', '登录系统后台成功', 'admin', '2020-12-22 07:02:33');
INSERT INTO `system_oplog` VALUES (7, 'admin/api.plugs/debug', '127.0.0.1', '系统运维管理', '由开发模式切换为产品模式', 'admin', '2020-12-22 07:35:03');
INSERT INTO `system_oplog` VALUES (8, 'admin/api.plugs/debug', '127.0.0.1', '系统运维管理', '由产品模式切换为开发模式', 'admin', '2020-12-22 07:35:05');
INSERT INTO `system_oplog` VALUES (9, 'admin/api.plugs/debug', '127.0.0.1', '系统运维管理', '由开发模式切换为产品模式', 'admin', '2020-12-22 07:35:06');
INSERT INTO `system_oplog` VALUES (10, 'admin/login/index', '127.0.0.1', '系统用户登录', '登录系统后台成功', 'admin', '2020-12-22 09:17:16');
INSERT INTO `system_oplog` VALUES (11, 'admin/menu/edit', '127.0.0.1', '系统菜单管理', '修改系统菜单[87]成功', 'admin', '2020-12-22 09:17:34');
INSERT INTO `system_oplog` VALUES (12, 'admin/login/index', '127.0.0.1', '系统用户登录', '登录系统后台成功', 'admin', '2020-12-22 09:40:00');
INSERT INTO `system_oplog` VALUES (13, 'admin/login/index', '127.0.0.1', '系统用户登录', '登录系统后台成功', 'admin', '2020-12-23 08:24:02');
INSERT INTO `system_oplog` VALUES (14, 'admin/config/storage', '127.0.0.1', '系统配置管理', '修改系统存储参数', 'admin', '2020-12-23 08:26:54');
INSERT INTO `system_oplog` VALUES (15, 'admin/config/storage', '127.0.0.1', '系统配置管理', '修改系统存储参数', 'admin', '2020-12-23 08:28:06');
INSERT INTO `system_oplog` VALUES (16, 'admin/config/storage', '127.0.0.1', '系统配置管理', '修改系统存储参数', 'admin', '2020-12-23 08:28:48');
INSERT INTO `system_oplog` VALUES (17, 'admin/config/storage', '127.0.0.1', '系统配置管理', '修改系统存储参数', 'admin', '2020-12-23 08:29:17');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统-任务' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of system_queue
-- ----------------------------
INSERT INTO `system_queue` VALUES (1, 'Q202012225306851', '同步微信用户数据', 'xadmin:fansall', 12736, '[]', 1608604986, '共获取 199 个用户数据，其中黑名单 19 人，获取到 5 个标签', 1608604997.4754, 1608605009.9439, 0, 1, 0, 3, '2020-12-22 02:24:40');
INSERT INTO `system_queue` VALUES (2, 'Q202012225351770', '同步微信用户数据', 'xadmin:fansall', 7184, '[]', 1608605031, '共获取 199 个用户数据，其中黑名单 19 人，获取到 5 个标签', 1608605033.7989, 1608605045.8132, 0, 1, 0, 3, '2020-12-22 02:25:25');
INSERT INTO `system_queue` VALUES (3, 'Q202012225517405', '同步微信用户数据', 'xadmin:fansall', 9664, '[]', 1608605117, '共获取 200 个用户数据，其中黑名单 19 人，获取到 5 个标签', 1608605118.9801, 1608605130.5472, 0, 1, 0, 3, '2020-12-22 02:26:50');
INSERT INTO `system_queue` VALUES (4, 'Q202012226018151', '同步微信用户数据', 'xadmin:fansall', 5508, '[]', 1608605418, '共获取 200 个用户数据，其中黑名单 19 人，获取到 5 个标签', 1608605421.0019, 1608605433.0744, 0, 1, 0, 3, '2020-12-22 02:31:52');
...
-- ----------------------------
INSERT INTO `system_user` VALUES (10000, 'admin', '21232f297a57a5a743894a0e4a801fc3', '系统管理员', 'http://127.0.0.1:8000/upload/0b/41ddc2fe3395af9c8de51282b70e87.jpg', ',,', '', '', '', '127.0.0.1', '2020-12-23 08:24:02', 44, '', 1, 0, 0, '2015-11-13 15:14:22');
